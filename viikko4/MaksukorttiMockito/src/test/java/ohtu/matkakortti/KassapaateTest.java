...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLadataanRahaaJosLadattavaSummaPositiivinen() {
    ...
    //kassapäätteen metodin lataa kutsu ei tee maksukortille mitään, 
    //jos ladattava summa on negatiivinen
    @Test
    public void kortilleEiLadataRahaaJosLadattavaSummaNegatiivinen() {
        kassa.lataa(kortti, -5);
